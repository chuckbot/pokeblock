...
<template>
  <figure class="rounded-xl border-[3px] border-[var(--secondary-color)]">
    <div class="flex w-full justify-center border-b-2 border-b-[var(--secondary-color)] p-8 bg-[var(--primary-color)]">
      <div class="rounded-full border-[2px] border-[var(--secondary-color)] p-4 bg-[var(--quaternary-color)]">
        <Image :alt="'Pokemon'" class="w-24 h-24 rounded" :height="512" :width="384" :path="nuxtLogo" />
      </div>
    </div>
